...
def main(hardargs=None):
    ...
    parser.add_option("-L", "--ltl", dest="ltl", default="", type="string", help="formula (.ltl file)")
    parser.add_option("-P", "--part", dest="part", default="", type="string", help="partition of atomic signals file (.part file)")
